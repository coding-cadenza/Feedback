<template>
  <div class="page-container">
    <div
      align="center"
      :class="{'hide-img' : hasfeedback}"
      class="img-container"
    ><img src="@/assets/images/noFeedBack.png"></div>
    <div
      v-if="total>0"
      align="center"
      :class="{'hide-page':hasnofeedback}"
    ...
    >
      ...
      >
        <el-carousel-item
          v-for="capture in list[currentpage-1].captures"
          :key="capture"
        >
          <img
            :src="capture"
  ...
  methods: {
    ...
    setTimer() {
      ...
      this.timer = setInterval(
        this.changePage,
        this.intervaltime * this.list[this.currentpage - 1].captures.length
      )
    },
    getLatestItem() {
